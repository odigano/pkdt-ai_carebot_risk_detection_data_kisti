...
-   사전 학습된 한국어 T5 모델인 **paust/pko-t5-small**을 기반으로 합니다.
-   추출 요약이 아닌 추상 요약을 목표로 합니다. 성능 평가 지표에서 ROUGE 등 형태론적 접근 지표는 떨어지지만 BERTScore 등 의미론적 접근 지표에서는 비교적 높은 성능을 보여줍니다.
